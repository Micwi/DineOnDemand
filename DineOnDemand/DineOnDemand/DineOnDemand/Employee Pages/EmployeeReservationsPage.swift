//
//  EmployeeReservationsPage.swift
//  DineOnDemand
//
...
class EmployeeReservationsPage: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func populateArrays() {
        ...
        database.collection("reservation")
            ...
            .whereField("day_of_reservation", isEqualTo: currentDate)
    ...
    // Changes a reservation's status to 'past' if the party is marked as 'present' by an Employee
...
class empReservationCell: UITableViewCell {
    @IBOutlet weak var timeLabel: UILabel!
    @IBOutlet weak var partyLabel: UILabel!
    @IBOutlet weak var reservedByLabel: UILabel!
